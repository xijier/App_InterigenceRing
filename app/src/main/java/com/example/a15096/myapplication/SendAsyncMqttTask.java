...
public class SendAsyncMqttTask extends AsyncTask<String, Void, Boolean> {
    ...
    public SendAsyncMqttTask(String deviceId,boolean isReceive)
    {
    ...
    protected boolean httpUrlConnPost(String value,String password){
        ...
        try {
            ...
            json.put("value", "012");//使用URLEncoder.encode对特殊和不可见字符进行编码
